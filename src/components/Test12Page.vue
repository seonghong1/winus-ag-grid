...
const columnDefs = [
  ...
  { headerName: '원주문번호', field: 'ORG_ORD_ID', width: 250, headerCheckboxSelection: true, checkboxSelection: true},
  { headerName: '주문번호',field: 'ORD_ID' , width:150, headerCheckboxSelection: true, checkboxSelection: true  },
  { headerName: 'SEQ', field: 'ORD_SEQ'  , width:80   },
  { headerName: '차수', field: 'ORD_DEGREE'  , width:80 },
  { headerName: '버튼', field: 'BUTTON'  , width:180, cellRenderer: TotalValueRenderer, headerCheckboxSelection: true   },
